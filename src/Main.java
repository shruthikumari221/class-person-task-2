...
class Student{
    ...
    public static void main(String args[]){
        ...
        Student s1=new Student("Alex",18,1234567891,10);//creating an s1 object of Student
        Student s2=new Student("Bob",18,1987654321,11);//creating an s2 object of Student
